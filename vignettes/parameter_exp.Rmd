...
After the cone mediated phase there follows the rod phase, S2, which is defined by its slope, ($\theta_4$, log$_{10}$(cd.m$^{\text{-}2}$).min$^{\text{-}1}$) and the rod cone transition time or alpha point ($\theta_5$, min). 

The linear (on a log-lin plot) rod phase S2, described in detail in [ref, Pugh and Lamb 2004], represents the rate limited restoration of photopigment.
